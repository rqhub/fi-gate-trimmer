...
//RKL #define PREVENT_COLD_EXTRUSION
// #define PREVENT_COLD_EXTRUSION
// RKL #define EXTRUDE_MINTEMP 170
#define EXTRUDE_MINTEMP 0

// This option prevents a single extrusion longer than EXTRUDE_MAXLENGTH.
// Note that for Bowden Extruders a too-small value here may prevent loading.
#define PREVENT_LENGTHY_EXTRUDE
//RKL #define EXTRUDE_MAXLENGTH 200
...
/// DISABLED
// RKL Disable- #define THERMAL_PROTECTION_HOTENDS // Enable thermal protection for all extruders
// RKL Disable- #define THERMAL_PROTECTION_BED     // Enable thermal protection for the heated bed
...
// RKL #define X_MIN_ENDSTOP_INVERTING false // set to true to invert the logic of the endstop.
// RKL #define Y_MIN_ENDSTOP_INVERTING false // set to true to invert the logic of the endstop.
// RKL #define Z_MIN_ENDSTOP_INVERTING false // set to true to invert the logic of the endstop.
...
// RKL #define XY_PROBE_SPEED 8000
...
// :[-1,1]
#define X_HOME_DIR -1 // RKL -1
#define Y_HOME_DIR -1 // RKL -1
#define Z_HOME_DIR -1
